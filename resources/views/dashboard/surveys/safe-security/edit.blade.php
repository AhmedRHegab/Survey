                            ...
                            <form action="{{route('dashboard.surveys.safe-security.update', $survey->id)}}" method="post" class=" mx-3" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" name="no_security" placeholder=" عدد افراد الامن " value="{{$survey->no_security}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <input type=" text " class=" form-control  " placeholder="" name="no_unit" value="{{$survey->no_unit}}">
                                        </div>
                                    </div>
